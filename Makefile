...
ACLOCAL = ${SHELL} '/root/bigcoin/build-aux/missing' aclocal-1.16
AMTAR = $${TAR-tar}
...
ARM_SHANI_CXXFLAGS = 
AS = as
AUTOCONF = ${SHELL} '/root/bigcoin/build-aux/missing' autoconf
AUTOHEADER = ${SHELL} '/root/bigcoin/build-aux/missing' autoheader
AUTOMAKE = ${SHELL} '/root/bigcoin/build-aux/missing' automake-1.16
...
CORE_CXXFLAGS =  -g -O2 -fno-extended-identifiers -fstack-reuse=none
CORE_LDFLAGS = 
COV_TOOL = 
COV_TOOL_WRAPPER = 
CPP = gcc -E
...
LUPDATE = 
MAINT = 
MAKEINFO = ${SHELL} '/root/bigcoin/build-aux/missing' makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
MINIUPNPC_LIBS = 
...
PACKAGE_STRING = Bitcoin Core 27.0.0
...
ZMQ_LIBS = -lzmq 
abs_builddir = /root/bigcoin
abs_srcdir = /root/bigcoin
abs_top_builddir = /root/bigcoin
abs_top_srcdir = /root/bigcoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /root/bigcoin/build-aux/install-sh
